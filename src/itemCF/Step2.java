...
/**
 * 按用户分组，计算所有物品出现的组合列表，得到用户对物品的喜爱度得分矩阵 u13 i160:1, u14 i25:1,i223:1, u16 i252:1,
 * u21 i266:1, u24 i64:1,i218:1,i185:1, u26 i276:1,i201:1,i348:1,i321:1,i136:1,
 * 
 * @author root
 * 
 */
public class Step2 {
	...
	public static boolean run(Configuration config, Map<String, String> paths) {
		try {
			...
			FileInputFormat
					.addInputPath(job, new Path(paths.get("Step2Input")));
	...
	static class Step2_Reducer extends Reducer<Text, Text, Text, Text> {
		...
		protected void reduce(Text key, Iterable<Text> i, Context context)
			...
			for (Text value : i) {
				...
				action = ((Integer) (r.get(item) == null ? 0 : r.get(item)))
						.intValue() + action;
				r.put(item, action);
			}
